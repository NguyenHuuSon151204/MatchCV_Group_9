...
const saveCV = async (cvData)=>{
    try {
        const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserId"])();
        // userId must be a query parameter as per CVController
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axiosConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BASE_PATH}/save?userId=${userId}`, {
            ...cvData,
            userId
        });
...
const getCVHistory = async ()=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axiosConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BASE_PATH}/user/${userId}`);
        return unwrapResponse(response);
    } catch (error) {
...
const getCVById = async (id)=>{
    ...
    try {
        const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserId"])();
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axiosConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BASE_PATH}/${id}?userId=${userId}`);
        return unwrapResponse(response);
    } catch (error) {
...
const deleteCV = async (id)=>{
    try {
        const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserId"])();
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axiosConfig$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${BASE_PATH}/${id}?userId=${userId}`);
        return response.data;
    } catch (error) {
...
//# sourceMappingURL=_5d1fa5c5._.js.map