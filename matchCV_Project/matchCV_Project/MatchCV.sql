...
BEGIN
    CREATE TABLE dbo.Jobs (
        ...
        RawText         NVARCHAR(4000) NULL,
        JobDescription  NVARCHAR(MAX) NULL,
        [Status]        NVARCHAR(50)  NOT NULL CONSTRAINT DF_Jobs_Status DEFAULT ('Active'),

        Deadline        DATETIME2 NULL,
        MaxApplicants   INT NULL,

        CreatedAt       DATETIME2 NOT NULL CONSTRAINT DF_Jobs_CreatedAt DEFAULT (SYSUTCDATETIME()),
        UpdatedAt       DATETIME2 NOT NULL CONSTRAINT DF_Jobs_UpdatedAt DEFAULT (SYSUTCDATETIME()),

        CONSTRAINT FK_Jobs_Users FOREIGN KEY (UserId) REFERENCES dbo.Users(Id) ON DELETE CASCADE
    );
...
CREATE TABLE Notifications (
    ...
    Role       NVARCHAR(50)  NOT NULL DEFAULT 'Candidate', -- Candidate | Recruiter | Admin
    UserId     INT NULL,
    Title      NVARCHAR(200) NOT NULL,
    Message    NVARCHAR(500) NOT NULL,
    Category   NVARCHAR(20)  NOT NULL DEFAULT 'info',      -- info/success/warning/error
